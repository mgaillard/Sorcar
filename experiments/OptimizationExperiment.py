...
# TODO: import a function from Casadi, generated by the Blender add-on
...
def main():
    ...
    # functions['underdetermined_circle']['function'].generate_code('casadi_circle_func.c')
    # new_function = CasadiFunction()
    # new_function.load_compile_code('casadi_circle_func.c')
